    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "inf":
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=_["S_B_8"], url=link, style=group_style),
                        InlineKeyboardButton(text=_["S_B_9"], url=config.SUPPORT_CHAT, style=group_style),
                    ],
                ]
            )
            await m.delete()
